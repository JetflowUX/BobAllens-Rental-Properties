...
export function Home() {
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="relative min-h-[80svh] md:min-h-screen flex items-end pb-16 sm:pb-20 md:pb-24 px-4 sm:px-6 md:px-12 pt-28 sm:pt-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-cream leading-[1.05] tracking-tight max-w-4xl text-balance mb-8 sm:mb-10">
      ...
      {/* Philosophy Section */}
      <section className="py-20 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 bg-cream">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 items-center">
          <div className="md:col-span-5">
            ...
            <p className="font-serif text-2xl sm:text-3xl md:text-4xl text-charcoal leading-snug text-balance">
      ...
      <section className="py-20 sm:py-24 px-4 sm:px-6 md:px-12 bg-surface">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-12 sm:mb-16 md:mb-24">
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-charcoal max-w-xl">
            ...
            {FEATURED_PROPERTIES.map((property, index) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className="font-serif text-2xl sm:text-3xl md:text-4xl text-charcoal mb-4">
                    {property.title}
                  </h3>
